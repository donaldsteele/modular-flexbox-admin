...
plugins.File = require('vinyl');
plugins.StringDecoder = require('string_decoder').StringDecoder;
plugins.dotenv = require('dotenv');
plugins.frontMatter = require('front-matter');
plugins.terser = require('gulp-terser');
plugins.extend = require('util')._extend;
...
const watch = (done) => {
    ...
    gulp.watch(paths.app.layouts, app_pages);
    // When partial changes recompile .html pages
    gulp.watch(paths.app.partials, app_pages);
